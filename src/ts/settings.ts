...
export const settings = {
    ...
    hills: [
        {amplitude: 18, color: new Hsl(149, 39, 35), radius: 35, startPosition: 220, withFir: true},
        {amplitude: 13, color: new Hsl(149, 39, 45), radius: 45, startPosition: 150, withFir: false},
        {amplitude: 3, color: new Hsl(149, 39, 55), radius: 80, startPosition: 60, withFir: false},
